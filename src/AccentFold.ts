...
//Util to Remove the accents from a string
...
/** removes all accents from string. Example: 'Áudio' to 'Audio' */
...
function accent_folded_hilite(str, q) {
  var str_folded = accentFold(str).toLowerCase().replace(/[<>]+/g, '')
  var q_folded = accentFold(q).toLowerCase().replace(/[<>]+/g, '')
